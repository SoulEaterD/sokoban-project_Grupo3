...
public class MenuInicio extends BorderPane {
    ...
    public MenuInicio(JuegoSokoban juego, GestorVentanas gestorVentanas) {
    ...
    private VBox crearMenu() {
        ...
        btnNuevaPartida =
                ComponentesUI.crearBotonPrincipal("Nueva partida");

        btnSeleccionNivel =
                ComponentesUI.crearBotonPrincipal("Seleccionar nivel");

        btnCreditos =
                ComponentesUI.crearBotonPrincipal("Créditos");

        btnSalir =
                ComponentesUI.crearBotonPrincipal("Salir");
    ...
    private void configurarEventos() {
        btnNuevaPartida.setOnAction(e ->
                gestorVentanas.nuevaPartida()
        );

        btnSeleccionNivel.setOnAction(e ->
                gestorVentanas.mostrarSeleccionNiveles()
        );

        btnCreditos.setOnAction(e ->
                gestorVentanas.mostrarCreditos()
        );
